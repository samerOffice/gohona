  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <a class="btn btn-outline-info float-right" href="{{route('today_rate_list')}}">
                        ...
                        <form method="post" action="{{route('update')}}">  
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                  ...
                                  <input type="text" required class="form-control" id="name" name="name" value="{{$today_rate->name}}">
                                </div>
  
                                <div class="form-group">
                                  <label for="product_category_name">Rate</label>
                                  <input type="text" required class="form-control" id="rate" name="rate" value="{{$today_rate->rate}}">
                                </div>
  
                                <div class="form-group">
                                  <label> Status </label>
                                  <label class="switch">
                                      <input type="checkbox" id="toggleButton" name="status" value="{{$today_rate->status}}" class="toggle-switch-checkbox">
                                      <span class="slider round"></span>
                                    </label>
                                </div>  
                              </div>
                            <!-- /.card-body -->
                            <input type="hidden" value="{{$today_rate->id}}" name="id">
