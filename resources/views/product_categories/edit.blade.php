            ...
            <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('update_product_category') }}">  
                            @csrf                  
                            <div class="card-body">
                              <div class="form-group">
                                <label for="product_category_name">Product Category Name</label>
                                <input type="text" required class="form-control" id="product_category_name" name="product_category_name" value="{{$product_category->product_category_name}}">
                              </div>
                            </div>
                            <!-- /.card-body -->
