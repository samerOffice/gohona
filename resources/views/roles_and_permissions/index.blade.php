  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <a class="btn btn-outline-info float-right" href="{{route('roles_and_permissions.create')}}">
                            ...
                            <a href="{{route('roles_and_permissions.edit', $role->id)}}" style="color: white"><button class="btn btn-outline-primary"><i class="fa-solid fa-pen-to-square"></i> Edit</button></a> |
                               <a onclick="Swal.fire({
                                 ...
                                 if (result.isConfirmed){
                                     var deleteRole = '{{ route('delete_role', $role->id )}}';
                                     window.location.href = deleteRole;
                                     Swal.fire({
                                     title: 'Deleted!',
