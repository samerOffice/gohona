                        ...
                        <div class="mb-3 row">
                            <div class="col-md-4">
                                ...
                                <select class="form-control select2bs4" id="client" required name="client" style="width: 100%;">
                                    <option value="{{$booking->client_id}}">{{$booking->client_name}}</option>
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-control select2bs4" id="booked_by" required name="booked_by" style="width: 100%;">
                                    <option value="{{$booking->user_id}}">{{$booking->booked_by_name}}</option>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-12">
                        ...
                        <select class="form-control select2bs4" id="product_nr" required name="product_nr" style="width: 100%;">
                            @foreach($booking_details as $booking_d)
                            <option value="{{$booking_d->product_id}}" selected="selected">{{$booking_d->product_nr}}</option>
                            @endforeach
