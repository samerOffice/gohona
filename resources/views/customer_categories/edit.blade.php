  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <a class="btn btn-outline-info float-right" href="{{route('customer_category.index')}}">
                        ...
                        <form method="post" action="{{route('customer_category.update',$customer_category->id) }}">  
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                  ...
                                  <input type="text" required class="form-control" id="name" name="name" value="{{$customer_category->name}}">
                                </div>
  
                                <div class="form-group">
                                  <label> Status </label>
                                  <label class="switch">
                                      <input type="checkbox" id="toggleButton" name="status" value="{{$customer_category->status}}" class="toggle-switch-checkbox">
                                      <span class="slider round"></span>
                                    </label>
                                </div>  
                              </div>
                            <!-- /.card-body -->
                            <input type="hidden" value="{{$customer_category->id}}" name="id">
