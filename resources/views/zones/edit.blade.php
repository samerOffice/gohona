  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <a class="btn btn-outline-info float-right" href="{{route('zone.index')}}">
                        ...
                        <form method="post" action="{{route('zone.update',$zone->id) }}">  
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                  ...
                                  <input type="text" required class="form-control" id="name" name="name" value="{{$zone->name}}">
                                </div>

                                <div class="form-group">
                                    <label for="product_category_name">District</label>
                                    <select class="form-control select2bs4" required name="district_id" style="width: 100%;">
                                        <option value="{{$zone->district_id}}">{{$zone->district_name}}</option>
                                  ...
                                  <div class="form-group">
                                    <label for="product_category_name">Note</label>
                                    <input type="text" class="form-control" id="note" name="note" value="{{$zone->note}}">
                                  </div>
  
                                <div class="form-group">
                                  <label> Status </label>
                                  <label class="switch">
                                      <input type="checkbox" id="toggleButton" name="status" value="{{$zone->status}}" class="toggle-switch-checkbox">
