                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-body">
                      ...
                      @if(!empty($booking_terms_and_conditions->id))
                        <form method="post" action="{{route('booking_terms_and_conditions.update',$booking_terms_and_conditions->id)}}">  
                            @csrf
                            @method('PUT')
                            <div class="card-body">   
                                  <div class="form-group">
                                    ...
                                    <textarea id="summernote"  name="terms">
                                      {{ $booking_terms_and_conditions->terms }}
                                    </textarea>
                                  </div>                                 
                              </div>
                            <!-- /.card-body -->
                            <input type="hidden" value="{{ $booking_terms_and_conditions->id }}" name="id">
                            <button type="submit" id="sub" class="btn btn-info float-right mr-4">Update</button>
                          </form>
                        @else
                        <div class="col-12">
                          <a class="btn btn-outline-info float-right" href="{{route('booking_terms_and_conditions.create')}}">
