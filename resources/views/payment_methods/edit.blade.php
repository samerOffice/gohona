                        ...
                        <form method="post" action="{{route('payment_method.update',$payment_method->id) }}">  
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                  ...
                                  <input type="text" required class="form-control" id="name" name="name" value="{{$payment_method->name}}">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2bs4" required name="under_type" style="width: 100%;">
                                        <option value="{{$payment_method->under_type}}">{{$payment_method->under_type}}</option>
                                ...
                                <div class="form-group">
                                  <label> Status </label>
                                  <label class="switch">
                                      <input type="checkbox" id="toggleButton" name="status" value="{{$payment_method->status}}" class="toggle-switch-checkbox">
                                      <span class="slider round"></span>
                                    </label>
                                </div>  
                              </div>
                            <!-- /.card-body -->
                            <input type="hidden" value="{{$payment_method->id}}" name="id">
